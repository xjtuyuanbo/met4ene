...
#SBATCH -o /share/mzhang/by276/wrf_data/met4ene/wrfout/logs/output.real.%j		# Name of stdout output file(%j expands to jobId)
#SBATCH -e /share/mzhang/by276/wrf_data/met4ene/wrfout/logs/errors.real.%j		# Name of stderr output file(%j expands to jobId)
